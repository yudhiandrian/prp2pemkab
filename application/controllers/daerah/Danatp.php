...
class Danatp extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->akses['akses'] == 'Y') {
            ...
            $this->load->view('daerah/danatp/view', $data);
        } else {
    ...
    public function detail($tahun, $encrypt_id)
    {
        ...
        $this->load->view('daerah/danatp/view_detail', $data);
    }
    ...
    public function form()
    {
        ...
        if ($opsi == "add") {
            ...
            $this->load->view('daerah/danatp/form_add', $data);
        } elseif ($opsi == "edit") {
            ...
            $this->load->view('daerah/danatp/form_edit', $data);
        } else {
