<script>
    ...
    function load_apbd() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('data-anggaran-defenitif/load-apbd2'); ?>",
                type: 'POST',
                data: {
                    id: "<?= $skpd['id_skpd']; ?>",
                    tahun: "<?=$tahun ?>",
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('data-anggaran-defenitif/skpd/form'); ?>',
            type: "POST",
            data: {
                opsi: "add",
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $.ajax({
            url: "<?= site_url('data-anggaran-defenitif/skpd/add'); ?>",
            type: 'POST',
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('data-anggaran-defenitif/skpd/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    url: '<?= site_url('data-anggaran-defenitif/skpd/delete_data'); ?>',
                    type: "POST",
                    data: {
                        id: $(this).data('id')
                    },
