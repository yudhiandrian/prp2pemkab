<script>
    ...
    function load_apbd() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('data-anggaran-defenitif/load-apbd'); ?>",
                type: 'POST',
                data: {
                    id: "<?= $skpd['id_skpd']; ?>",
                    tahun: "<?= $tahun; ?>"
    ...
    $(document).on("click", "#tombol-upload", function() {
        ...
        $.ajax({
            url: '<?= site_url('data-anggaran-defenitif/form-upload'); ?>',
            type: "POST",
            data: {
                skpd: "<?= $skpd['id_skpd']; ?>"
            },
    ...
    $(document).on("submit", "#form-upload", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('data-anggaran-defenitif/upload'); ?>",
            type: "POST",
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    url: '<?= site_url('data-anggaran-defenitif/delete'); ?>',
                    type: "POST",
                    data: {
                        id: $(this).data('id')
                    },
