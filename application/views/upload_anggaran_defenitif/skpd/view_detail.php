...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Data Realisasi Anggaran Defenitif Pada APBD <?= $skpd['nama_skpd'] ?></h3>
        </div>
    </div>
</div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <h3 class="pb-3 fw-bold"><?= $skpd['nama_skpd'] ?></h3>
                        ...
                        <a href="<?= base_url('uploads/format/Format_defenitif.xls') ?>" target="_blank" class="btn btn-success btn-round btn-sm mr-2 mb-3"><i class="fa fa-download"></i> Format Excel</a>
...
<?php $this->load->view('upload_anggaran_defenitif/skpd/js_detail'); ?>
