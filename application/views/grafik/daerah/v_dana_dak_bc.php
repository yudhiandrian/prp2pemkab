<div class="card-body bg-primary-gradient">
    <div class="inner">
        <h2 style="color: white; font-weight: bold;"> <i class="fa fa-chart-bar"></i><i class="fa fa-chart-bar"></i> Realisasi RKUD Dana Alokasi Khusus (DAK) <?=$nama_kabupaten?></h2>
        <div class="row">
            <div class="col-lg-8 col-12">
                <div id="realisasi-dana-dak" style="width:100%; height: 410px;"></div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-12">
                                ...
                                <h4 class="mb-1 fw-bold">Pagu : 
                                    ...
                                    <br><br>Realisasi RKUD :  
                                    <?= "Rp " . format_angka($realisasi_pb_provinsi['dak_real_total']); ?>
        ...
        <br>
        <h2 style="color: white; font-weight: bold;"> <i class="fa fa-chart-bar"></i><i class="fa fa-chart-bar"></i> Persentase Realisasi RKUD Dana Alokasi Khusus (DAK) <?=$nama_kabupaten?></h2>
        <div class="row">
            <div class="col-lg-12 col-12">
                <div id="realisasi-dana-dak-persen" style="width:100%; height: 500px;"></div>
            </div>
        </div>
        <br>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-12">
                                ...
                                <h4 class="mb-1 fw-bold">Anggaran : 
                                    <?= "Rp " . format_angka($realisasi_pb_provinsi['dak_real_total']); ?>
                                    <br><br>Realisasi:  
                                    <?= "Rp " . format_angka($realisasi_pb_provinsi['dak_real_total1']); ?>
                                    <br>Persen : <?= hitung_persen($realisasi_pb_provinsi['dak_real_total1'],$realisasi_pb_provinsi['dak_real_total'],1); ?> %
                                </h4>
                                <div class="px-2 pb-2 pb-md-0 text-center">
