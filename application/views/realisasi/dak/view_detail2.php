...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Realisasi Dana Alokasi Khusus DAK <?= $skpd['nama_skpd'] ?>  Priode <?=bulan($bulan)?> <?=$tahun?></h3>
        </div>
    </div>
</div>
...
<?php $this->load->view('realisasi/dak/js_detail2'); ?>
