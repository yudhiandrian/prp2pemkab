...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">Realisasi Dana Tugas Pembantuan <?= $skpd['nama_skpd'] ?> Tahun <?=$tahun?></h3>
        </div>
    </div>
</div>
                    ...
                    <h3 class="pb-3 fw-bold"><?= $skpd['nama_skpd'] ?></h3>
                        <div class="ml-sm-auto py-md-0">
                            <?php if($tahun_now==$tahun){ ?>
                                <button id="tombol-upload" class="btn btn-warning btn-round btn-sm mr-2 mb-3" data-toggle="modal" data-target="#modal-form-action">Input Bulan</button>
                            <?php } ?>
                        </div>
                    </div>
...
<?php $this->load->view('realisasi/tugas/js_detail'); ?>
