<script>
    ...
    function load_apbd() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('upload-anggaran-opd/load-anggaran'); ?>",
                type: 'POST',
                data: {
                    id: "<?= $skpd['id_skpd']; ?>",
                    tahun: "<?= $tahun; ?>"
    ...
    $(document).on("click", "#tombol-upload", function() {
        ...
        $.ajax({
            url: '<?= site_url('upload-anggaran-opd/form-upload'); ?>',
            type: "POST",
            data: {
                skpd: "<?= $skpd['id_skpd']; ?>"
            },
    ...
    $(document).on("submit", "#form-upload", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('upload-anggaran-opd/upload'); ?>",
            type: "POST",
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('upload-anggaran-opd/form'); ?>',
            type: "POST",
            data: {
                opsi: "add",
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('upload-anggaran-opd/add'); ?>",
            type: 'POST',
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('upload-anggaran-opd/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    url: '<?= site_url('upload-anggaran-opd/delete'); ?>',
                    type: "POST",
                    data: {
                        id: $(this).data('id')
                    },
