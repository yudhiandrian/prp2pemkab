<?php
	...
	$zoom=$kordinat['zoom'];
	if($zoom==0){$latitude=2.936025308775414; $longitude=99.00081646225541; $zoom=12;}else{
        ...
        <script>
          function initialize() 
		  {
			var mapOptions = {
				...
				peta_proyek.loadGeoJson('<?= site_url('kegiatan/koor_kegiatan/koordinat_skpd/'.$tahun.'/'.$skpd['id_skpd']); ?>');
