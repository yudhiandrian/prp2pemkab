...
$(document).ready(function() {
    ...
    function load_data(tahun) {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('dana-dekonsentrasi/load_anggaran'); ?>",
                type: 'POST',
                data: {
                    id: "<?= $skpd['id_skpd']; ?>",
                    tahun: tahun
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('dana-dekonsentrasi/form'); ?>',
            type: "POST",
            data: {
                opsi: "add",
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $.ajax({
            url: "<?= site_url('dana-dekonsentrasi/add'); ?>",
            type: 'POST',
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('dana-dekonsentrasi/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        e.preventDefault();
        url = '<?= site_url('dana-dekonsentrasi/delete'); ?>';
        id = $(this).data('id');
