            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="id_skpd" id="id_skpd" value="<?= $row_skpd['id_skpd']; ?>">
                        <input type="text" name="nama_skpd" id="nama_skpd" value="<?= $row_skpd['nama_skpd']; ?>" class="form-control" readonly>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_unit" id="nama_unit" class="form-control" autocomplete="off">
