<script>
    ...
    function load_data() {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('jenis-pelaksanaan/load'); ?>",
                type: 'POST'
            },
            columnDefs: [{
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('jenis-pelaksanaan/form'); ?>',
            type: "POST",
            data: {
                opsi: "add"
            },
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('jenis-pelaksanaan/add'); ?>",
            type: 'POST',
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('jenis-pelaksanaan/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    url: '<?= site_url('jenis-pelaksanaan/delete'); ?>',
                    type: "POST",
                    data: {
                        id: $(this).data('id')
                    },
