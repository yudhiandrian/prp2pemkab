<script>
    ...
    function load_data(tahun) {
        ...
        table = $('#load-content').DataTable({
            ...
            ajax: {
                url: "<?= site_url('master/anggaran_kabupaten/load'); ?>",
                type: 'POST',
                data: {
                    tahun: tahun
                }
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: '<?= site_url('master/anggaran_kabupaten/form_add'); ?>',
            type: "POST",
            data: {
                tahun: $('#tahun').val()
            },
    ...
    $(document).on("submit", "#form-tambah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('master/anggaran_kabupaten/add'); ?>",
            type: 'POST',
    ...
    $(document).on("click", "#tombol-ubah", function() {
        ...
        $.ajax({
            url: '<?= site_url('master/anggaran_kabupaten/form_edit'); ?>',
            type: "POST",
            data: {
                id: $(this).data('id')
            },
    ...
    $(document).on("submit", "#form-ubah", function(e) {
        ...
        $(self).html("<i class='fa fa-circle-notch fa-spin fa-sm'></i> LOADING...");
        $.ajax({
            url: "<?= site_url('master/anggaran_kabupaten/edit'); ?>",
            type: 'POST',
            data: $(form_id).serialize(),
            dataType: "json",
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    url: '<?= site_url('master/anggaran_kabupaten/delete'); ?>',
                    type: "POST",
                    data: {
                        id: $(this).data('id')
                    },
